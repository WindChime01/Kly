...
<div class="page">
	<div class="content" id="main_content">
		...
		<div class="">
            <a  href="javascript:history.back(-1)" ><i class="icon icon-left" style="padding-top:10%"></i></a>
			<a class="top-title" style="font-size:32px;text-align:center;color:#0A294F;">提现</a>
		...
		<div class="row" style="width:95%;border-radius:5px;margin:10px auto;margin-top:0;">
			...
			<div class="main_now_tab">
				...
				<div class="content-padded lobby-nav">
				    <span>钱包地址</span>
                    <input type="select" id="" value="" readonly="readonly" style="height:36px;width:100%;margin-bottom:5%;border-color:#C4C8CC" >
                    <select style="margin-left:67%;" lay-ignore>
                        <option >d5w74s25a3</option>
                        <option>d5w74s25a3</option>
                    </select>
                    </div>
                <div class="content-padded lobby-nav">   
                    ...
                    <input type="text" id="" value="" readonly="readonly" style="height:36px;width:100%;margin-bottom:5%;border-color:#C4C8CC" >
                     ...
                     <select id="Typecoin" name="icon" lay-ignore>
                    ...
                    <input type="number" name="amount" value="10.00" style="height:72px;width:100%;margin-bottom:5%;border-color:#C4C8CC;" >
                    </div>
                    <div class="content-padded lobby-nav">   
                    <span>交易密码</span>
                    <input type="password" id="" name="password" value="" style="height:36px;width:100%;margin-bottom:5%;border-color:#C4C8CC;text-align:right" >
                    </div>
                    <a lay-submit class="button button-success" onclick="sub()" lay-filter="s" style="height:36px;width:100%;background: linear-gradient(315deg, #234ADB 0%, #4269FA 100%);color:white;text-align:center;margin-top:40%">提交</a>
...
<script type="text/javascript">
    layui.use(['layer','jquery','form'],function(){
        ...
        form.on('submit(s)',function(data){
            $.post("/index/add/withdrawal",(data.field),function(res){
        ...
        var is_set = <?php echo ($is_set); ?>;
    	if (is_set == 0){
    		layer.confirm("系统检测到您未设置收款信息，请点击确认前往设置",function(){
    			window.location.href = "/index/index/bank"
    		});
    	}
    });
