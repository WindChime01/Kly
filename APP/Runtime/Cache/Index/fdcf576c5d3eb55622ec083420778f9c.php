				...
				<div style="margin: 0 1rem 0 1rem">
					...
					<div class="main-box">
						<div class="item-inner" style="height:70px;border-top: none">
                            ...
                            <div class="item-input">
                                <input type="text" style="width:50%;color:#fff" placeholder="验证码" name="code" required id="code" class="fl">

								<span  id="count_down" onClick="send_sms_reg_code()" class="button button-fill fr reg-mobile-js" style="overflow:hidden;margin-top:0.4rem;background:#4099FC">获取验证码</span>
                            </div>
     ...
     <!--                   </div>-->
					...
					<div class="main-box">
						<div class="item-inner" style="height:70px;border-top: none">
                            ...
                            <div class="item-input">
                                <?php echo ($tgkey); ?>
                                <input name="parent" id="parent" type="hidden" value="<?php echo ($tgkey); ?>">
                            </div>
	...
	function reg() {
        ...
        $.post('/Index/Sem/regpost',$data,function (response) {
            ...
            if ($data.success == 0) {
                ...
                //注册成功
                layer.msg($data.msg + '即将为您跳转至APP下载页面...请选择到浏览器打开');
                setTimeout(function(){
                    window.location.href = 'http://app.wmg9r9.cn/v/bk55d6';
                },1000);
            }
        })
    }
