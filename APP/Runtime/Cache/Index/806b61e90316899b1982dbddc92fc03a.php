...
<div class="page">
	<div class="content" id="main_content">
		...
		<div class="">
			...
			<a class="top-title" style="font-size:32px;text-align:center;color:#0A294F;">充值</a>
		...
		<div class="row" style="width:95%;border-radius:5px;margin:10px auto;margin-top:0;">
			...
			<div class="main_now_tab">
				...
				<div class="content-padded lobby-nav">
                    ...
                    <select style="margin-left:67%;" id="TypeA" lay-ignore>
                    ...
                    <input type="number" id="" name="amount" value="10.00" style="height:72px;width:100%;margin-bottom:5%;border-color:#C4C8CC;" >
                    </div>
                    <div class="content-padded lobby-nav">   
                    <span>交易密码</span>
                    ...
                    <div class="content-padded lobby-nav">   
                    <a lay-submit class="button button-success" lay-filter="s" style="height:36px;width:100%;margin-bottom:5%;background: linear-gradient(315deg, #234ADB 0%, #4269FA 100%);color:white;text-align:center;margin-top:60%">提交</a>
...
<script type="text/javascript">
    layui.use(['layer','jquery','form'],function(){
        ...
        form.on('submit(s)',function(data){
            $.post("/index/add/up",(data.field),function(res){
