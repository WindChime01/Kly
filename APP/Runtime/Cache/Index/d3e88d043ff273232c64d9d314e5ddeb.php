...
<div class="page" style="background:#fff">
	...
	<header class="bar bar-nav" style="background:#10143E">
		...
		<a style="position: absolute;z-index: 19;width: 94%;text-align: center;display: inline-block;line-height: 50px;font-size: 0.85rem; color:#FFF;">公告</a>    <div class="logo">
	...
	<div class="content" id="main_content" style="margin-bottom:10px;padding-top:10px">

		<!--<div class="buttons-tab"></div>-->
		<!--class card-header-->
		<div class="" style="text-align:left; font-size:0.85rem;color:#fff;border-bottom:1px solid #ccc;padding: 0.5rem 0.75rem">
			<p style="letter-spacing:4px;line-height:1rem;color:#292929;"><?php echo ($new["title"]); ?></p>
			<p style="font-size:0.75rem;color:#808080;line-height:1rem;margin-top:0.5rem"><?php echo (date("Y-m-d",$new["addtime"])); ?></p>
			
		</div>

		<div class="news-content" style="padding: 0.75rem;color:#ccc">
