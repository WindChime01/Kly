...
<div class="page" style="background:#10143E">



	<!-- 标题栏 -->

	<header class="bar bar-nav" style="background:#253057">



		<a style="position: absolute;z-index: 19;width: 94%;text-align: center;display: inline-block;line-height: 50px;font-size: 0.85rem; color:#FFF;">错误页面</a>    <div class="logo">
	...
	<div style="width:90%;color:#ccc;font-size:0.85rem;margin: 70px auto">
		页面不存在！3 秒后将自动返回...
	</div>
