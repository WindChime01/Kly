...
</script>			<div id="main-content" class="clearfix">				<div id="breadcrumbs">					<ul class="breadcrumb">						<li>							<i class="icon-home"></i>							<a href="#">Home</a>							<span class="divider">								<i class="icon-angle-right"></i>							</span>						</li>						<li>							<a href="#">权限管理</a>							<span class="divider">								<i class="icon-angle-right"></i>							</span>						</li>					</ul><!--.breadcrumb-->				</div>				<div id="page-content" class="clearfix">					<div class="page-header position-relative">						<div style="text-align:left;width:100%;">						    <a type="button" href="<?php echo U(GROUP_NAME.'/Rbac/addNode');?>" class="btn btn-info btn-small no-border"> <i class="icon-plus icon-white"></i> 添加节点</a>						</div>					</div><!--/.page-header-->					<div class="row-fluid">						<!--PAGE CONTENT BEGINS HERE-->							<div class="row-fluid">								<div id="wrap">		<a href="<?php echo U(GROUP_NAME .'/Rbac/addNode');?>" class="add-app">添加应用</a>		<?php if(is_array($node)): foreach($node as $key=>$app): ?><div class="app">				<p>					<strong class="blue"><?php echo ($app["title"]); ?>[<a href="<?php echo U(GROUP_NAME .'/Rbac/addNode',array('pid'=>$app['id'],'level'=>2));?>">添加控制器</a>]</strong>					[<a href="<?php echo U(GROUP_NAME .'/Rbac/editNode',array('nid'=>$app['id']));?>">修改</a>]					[<a href="<?php echo U(GROUP_NAME .'/Rbac/deleteNode',array('nid'=>$app['id'],'type'=>1));?>">删除</a>]				</p>						<?php if(is_array($app['child'])): foreach($app['child'] as $key=>$action): ?><dl>					<dt>						<strong class="red"><?php echo ($action["title"]); ?></strong>						[<a href="<?php echo U(GROUP_NAME .'/Rbac/addNode',array('pid'=>$action['id'],'level'=>3));?>">添加方法</a>] [<a href="<?php echo U(GROUP_NAME .'/Rbac/editNode',array('nid'=>$action['id']));?>">修改</a>] [<a href="<?php echo U(GROUP_NAME .'/Rbac/deleteNode',array('nid'=>$action['id'],'type'=>2));?>">删除</a>]					</dt>								<?php if(is_array($action['child'])): foreach($action['child'] as $key=>$method): ?><dd>						<span><?php echo ($method["title"]); ?></span>						[<a href="<?php echo U(GROUP_NAME .'/Rbac/editNode',array('nid'=>$method['id']));?>">修改</a>]						[<a href="<?php echo U(GROUP_NAME .'/Rbac/deleteNode',array('nid'=>$method['id'],'type'=>3));?>">删除</a>]					</dd><?php endforeach; endif; ?>				</dl><?php endforeach; endif; ?>			</div><?php endforeach; endif; ?>	</div>						</div><!--/row-->						<!--PAGE CONTENT ENDS HERE-->					</div><!--/row-->				</div><!--/#page-content-->				<div id="ace-settings-container">					<div class="btn btn-app btn-mini btn-warning" id="ace-settings-btn">						<i class="icon-cog"></i>					</div>					<div id="ace-settings-box">						<div>							<div class="pull-left">								<select id="skin-colorpicker" class="hidden">									<option data-class="default" value="#438EB9">#438EB9</option>									<option data-class="skin-1" value="#222A2D">#222A2D</option>									<option data-class="skin-2" value="#C6487E">#C6487E</option>									<option data-class="skin-3" value="#D0D0D0">#D0D0D0</option>								</select>							</div>							<span>&nbsp; 选择样式</span>						</div>						<div>							<input type="checkbox" class="ace-checkbox-2" id="ace-settings-header" />							<label class="lbl" for="ace-settings-header"> Fixed Header</label>						</div>						<div>							<input type="checkbox" class="ace-checkbox-2" id="ace-settings-sidebar" />							<label class="lbl" for="ace-settings-sidebar"> Fixed Sidebar</label>						</div>					</div>				</div><!--/#ace-settings-container-->			</div><!--/#main-content-->		</div><!--/.fluid-container#main-container-->		<!--basic scripts-->		<script type="text/javascript">			window.jQuery || document.write("<script src='__PUBLIC__/js/jquery-1.9.1.min.js'>"+"<"+"/script>");		</script>		<!--page specific plugin scripts-->		<script src="__PUBLIC__/js/bootbox.min.js"></script>				<script src="__PUBLIC__/js/bootstrap.min.js"></script>					<!--bbc scripts-->		<script src="__PUBLIC__/js/bbc-elements.min.js"></script>		<script src="__PUBLIC__/js/bbc.min.js"></script>	</body></html>