	...
	function intoApply($id) {
			...
			<div id="main-content" class="clearfix">
				...
				<div id="page-content" class="clearfix">
					...
					<div class="row-fluid">
						...
						<form id="table-searchbar" method="POST" class="form-inline well well-small">
								<div class="row-fluid">&nbsp;&nbsp;昨日销售额:<?php echo ($today_sale); ?>

								<div class="row-fluid">&nbsp;&nbsp;各节点积分总和:<?php echo ($all_integral); ?>

								<div class="row-fluid">&nbsp;&nbsp;每积分收益:<?php echo ($average_income); ?>

								<div class="row-fluid">&nbsp;&nbsp;可分配收益:<?php echo ($all_reward); ?>
		...
		<script type="text/javascript">
			...
			function change_reward_status(){
			    if(confirm("确认要分配吗?")){
				$.post("<?php echo U(GROUP_NAME .'/IntegralReward/change_reward_status');?>","",function(e){
			...
			function clear1(){
				...
				if(confirm("确认要导出所查询信息吗?")){
					$('#table-searchbar').attr('action',"<?php echo U(GROUP_NAME .'/IntegralReward/excel?type=1');?>").submit();
			...
			function clear2(){
				...
				if(confirm("确认要导出全部信息吗?")){
					$('#table-searchbar').attr('action',"<?php echo U(GROUP_NAME .'/IntegralReward/excel?type=2');?>").submit();
					$('#table-searchbar').removeAttr('action');
				}
			}
