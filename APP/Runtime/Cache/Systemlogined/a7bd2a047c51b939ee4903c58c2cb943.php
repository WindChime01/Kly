...
</script>			<div id="main-content" class="clearfix">				<div id="breadcrumbs">					<ul class="breadcrumb">						<li>							<i class="icon-home"></i>							<a href="#">Home</a>							<span class="divider">								<i class="icon-angle-right"></i>							</span>						</li>						<li>							<a href="#">矿机管理</a>							<span class="divider">								<i class="icon-angle-right"></i>							</span>						</li>					</ul><!--.breadcrumb-->				</div>				<div id="page-content" class="clearfix">					<div class="page-header position-relative">						<h1>							修改雇佣						</h1>					</div><!--/.page-header-->					<div class="row-fluid">						<!--PAGE CONTENT BEGINS HERE-->							<form class="form-horizontal" name="editgoods"  enctype="multipart/form-data" action="<?php echo U(GROUP_NAME .'/add/editgoods');?>" method="post">							<input type="hidden"  name="id" value="<?php echo ($goods["id"]); ?>">								<div class="control-group">									<label class="control-label" for="goods_name"> 雇佣名称</label>                                   									<div class="controls">										<input type="text" value="<?php echo ($goods["goods_name"]); ?>" name="goods_name" id="goods_name" placeholder="" />									</div>								</div>								<!--<div class="control-group">-->								<!--	<label class="control-label" for="tid"> 分类</label>-->								<!--	<div class="controls">-->								<!--	   <select name="tid">-->								<!--	     <option value="-1">请选择分类</option>	   -->								<!--			<?php if(is_array($types)): foreach($types as $key=>$type): ?>-->								<!--				<?php if($goods["tid"] == $type["id"]): ?>-->								<!--					<option value="<?php echo ($type["id"]); ?>" selected><?php echo ($type["name"]); ?></option>-->								<!--				<?php else: ?>-->								<!--					<option value="<?php echo ($type["id"]); ?>"><?php echo ($type["name"]); ?></option>-->								<!--<?php endif; ?>-->																					<!--<?php endforeach; endif; ?>-->								<!--		</select>-->								<!--	</div>-->								<!--</div>-->								<div class="control-group">									<label class="control-label" for="price"> 单价（元）</label>									<div class="controls">										<input type="text" value="<?php echo ($goods["price"]); ?>" name="price" id="price" placeholder="" />																			</div>								</div>								<div class="control-group">									<label class="control-label" for="stock"> 库存</label>									<div class="controls">										<input type="text" value="<?php echo ($goods["stock"]); ?>" name="stock" id="stock" placeholder="" />									</div>								</div>										<div class="control-group">									<label class="control-label" for="income">每日收益</label>									<div class="controls">										<input type="text" value="<?php echo ($goods["income"]); ?>" name="income" id="income" placeholder="" />									</div>								</div>									<div class="control-group">									<label class="control-label" for="hire_day">雇佣天数</label>									<div class="controls">										<input type="text" value="<?php echo ($goods["hire_day"]); ?>" name="hire_day" id="hire_day" placeholder="" />																			</div>								</div>									<!--<div class="control-group">-->								<!--	<label class="control-label" for="shouyi"> 收益</label>-->								<!--	<div class="controls">-->								<!--		<input type="text" value="<?php echo ($goods["shouyi"]); ?>" name="shouyi" id="shouyi" placeholder="" /> /每小时-->								<!--	</div>-->								<!--</div>-->                                                                                                 <div class="control-group">									<label class="control-label" for="status"> 上下架</label>									<div class="controls">										                                                                                  <select name="is_on">                                            <option value="0" <?php if($goods['status'] == 0 ): ?>selected="selected"<?php endif; ?>>上架</option>                                            <option value="1" <?php if($goods['status'] == 1 ): ?>selected="selected"<?php endif; ?>>下架</option>                                         </select>                                                                                                                        									</div>								</div>	                                              														<div class="form-actions">									<button class="btn btn-info no-border" type="submit">										<i class="icon-ok bigger-110"></i>										保存添加									</button>								</div>							</form>						<!--PAGE CONTENT ENDS HERE-->					</div><!--/row-->				</div><!--/#page-content-->				<div id="ace-settings-container">					<div class="btn btn-app btn-mini btn-warning" id="ace-settings-btn">						<i class="icon-cog"></i>					</div>					<div id="ace-settings-box">						<div>							<div class="pull-left">								<select id="skin-colorpicker" class="hidden">									<option data-class="default" value="#438EB9">#438EB9</option>									<option data-class="skin-1" value="#222A2D">#222A2D</option>									<option data-class="skin-2" value="#C6487E">#C6487E</option>									<option data-class="skin-3" value="#D0D0D0">#D0D0D0</option>								</select>							</div>							<span>&nbsp; 选择样式</span>						</div>						<div>							<input type="checkbox" class="ace-checkbox-2" id="ace-settings-header" />							<label class="lbl" for="ace-settings-header"> Fixed Header</label>						</div>						<div>							<input type="checkbox" class="ace-checkbox-2" id="ace-settings-sidebar" />							<label class="lbl" for="ace-settings-sidebar"> Fixed Sidebar</label>						</div>					</div>				</div><!--/#ace-settings-container-->			</div><!--/#main-content-->		</div><!--/.fluid-container#main-container-->		<script src="__PUBLIC__/js/jquery-1.9.1.min.js"></script>		<!--page specific plugin scripts-->		<script src="__PUBLIC__/js/bootbox.min.js"></script>				<script src="__PUBLIC__/js/bootstrap.min.js"></script>					<!--bbc scripts-->		<script src="__PUBLIC__/Js/jquery.validate.min.js"></script>		<!--自定义JS-->										<script src="__PUBLIC__/js/bbc-elements.min.js"></script>		<script src="__PUBLIC__/js/bbc.min.js"></script>	</body></html>