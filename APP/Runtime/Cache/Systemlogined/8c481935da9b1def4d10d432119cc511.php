				...
				<div id="page-content" class="clearfix">
                       ...
                       <div class="page-header position-relative">
						   ...
						   <div style="text-align:left;width:100%;">
						    ...
						    <a type="button" href="<?php echo U(GROUP_NAME.'/index/add_prize');?>" class="btn btn-info btn-small no-border"> <i class="icon-plus icon-white"></i>添加抽奖奖品</a>
                                    ...
                                    <?php if(is_array($list)): foreach($list as $key=>$v): ?><tbody> 
										...
										<tr>
											...
											<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																...
																<a class="green" href="<?php echo U(GROUP_NAME .'/index/edit_prize',array('id'=>$v['id']));?>">
																...
																<a class="red" onclick="return confirm('你确定要删除吗')" href="<?php echo U(GROUP_NAME .'/index/delete_prize',array('id'=>$v['id']));?>">
