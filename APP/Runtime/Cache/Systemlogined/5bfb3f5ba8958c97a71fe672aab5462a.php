							...
							<form class="form-horizontal"  enctype="multipart/form-data"  method="post">
								...
								<div class="control-group">
									...
									<div class="controls">
										...
										<input type="text" required="required" value='<?php echo ($list["prize_name"]); ?>' name="prize_name" id="prize_name" placeholder="" />
								...
								<div class="control-group">
									...
									<div class="controls">
										...
										<input type="text" required="required" value='<?php echo ($list["probability"]); ?>' name="probability" id="probability" placeholder="" />
