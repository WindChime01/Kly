						...
						<div class="row-fluid">
							...
							<div class="span7 infobox-container" style="width:90%;">
								...
								<div class="infobox infobox-orange2  ">
									...
									<div class="infobox-data">
										<button style="margin-left:20%" onclick="fafang()">点击发放奖励</button>
										<p>最近发放时间：<?php echo ($data_time); ?></p>
								</div>
								<img width="40" height="30" src="data:image/png;base64," />
        <!--                       <div class="infobox infobox-red  ">-->
...
-->
	...
	function qrcode(){
		layer.confirm("确定要生成二维码吗。",function(){
			$.ajax({
				url: "/Auto/Timing/test2",
				type: "POST",
				success: function(res){
					layer.closeAll();
					layer.msg('生成成功',{time:1500},function(){
					})
				}
			})
		})
